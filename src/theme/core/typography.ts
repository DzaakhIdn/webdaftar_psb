...
import { createTheme as getTheme, Breakpoint } from '@mui/material/styles';
...
interface ResponsiveFontSizesObj {
...
function responsiveFontSizes(obj: ResponsiveFontSizesObj) {
  const breakpoints = defaultMuiTheme.breakpoints.keys as Breakpoint[];

  return breakpoints.reduce((acc: Record<string, { fontSize: string }>, breakpoint) => {
