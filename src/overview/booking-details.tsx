...
function RowItem({ row }: { row: BookingDetailsProps["tableData"][number] }) {
  ...
  return (
    <>
      <TableRow>
        ...
        <TableCell>
          <ListItemText
            primary={fDate({ date: row.checkIn })}
            secondary={fTime({ date: row.checkIn })}
            slotProps={{
              primary: {
                noWrap: true,
                sx: { typography: "body2" },
        ...
        <TableCell>
          <ListItemText
            primary={fDate({ date: row.checkOut })}
            secondary={fTime({ date: row.checkOut })}
            slotProps={{
              primary: {
                noWrap: true,
                sx: { typography: "body2" },
