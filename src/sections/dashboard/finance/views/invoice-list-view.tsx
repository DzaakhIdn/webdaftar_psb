...
export function InvoiceListView() {
  ...
  const [tableData, setTableData] = useState<Invoice[]>(_invoices as Invoice[]);
            ...
            <TableSelectedAction
              ...
              onSelectAllRows={(checked) => {
                table.onSelectAllRows(
                  checked,
                  dataFiltered.map((row: Invoice) => row.id)
                );
              }}
              action={
                <Box sx={{ display: "flex" }}>
                  ...
                  {dataFiltered
                    ...
                    .map((row: Invoice) => (
                      <InvoiceTableRow
                        ...
                        editHref={paths.dashboard.finance.overview}
...
function applyFilter({
  ...
  if (!dateError) {
    if (startDate && endDate) {
      inputData = inputData.filter((invoice) =>
        fIsBetween({ inputDate: invoice.createDate, startDate, endDate })
      );
    }
  }
