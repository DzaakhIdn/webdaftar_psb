...
import { InvoicePaymentsRow } from "../invoice-payments-row";
import { InvoiceTableToolbar } from "../invoice-table-toolbar";
import { InvoiceTableFiltersResult } from "../invoice-table-filters-result";
import { _userList, USER_STATUS_PAYMENT } from "@/_mock";
...
const STATUS_OPTIONS = [{ value: "all", label: "All" }, ...USER_STATUS_PAYMENT];

const TABLE_HEAD = [
  { id: "name", label: "Name", width: 250 },
  { id: "phoneNumber", label: "No HP", width: 200 },
  { id: "pembayaran", label: "Pembayaran", width: 200 },
  ...
  return (
    <>
      <DashboardContent maxWidth={false}>
        <CustomBreadcrumbs
          heading="List Pembayaran" // List Pembayaran
          links={[
            ...
            {STATUS_OPTIONS.map((tab) => (
              <Tab
                ...
                icon={
                  ...
                  >
                    {["paid", "unpaid", "expired"].includes(tab.value)
