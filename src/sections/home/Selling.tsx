...
const bentoItems = [
  {
    id: 1,
    title: "Bahasa arab",
    description: "Santri menguasai 4 kemahiran : mendengar, berbicara, membaca dan menulis",
    icon: Sparkle,
  ...
  },
  {
    ...
    description: "Melatih santri berkomunikasi aktif dengan fokus pada reading, writing, listening, speaking",
    icon: Smile,
  ...
  },
  {
    id: 3,
    title: "Diniyyah",
    description: "Mengenal dasar agama membekali santri dengan aqidah, fiqih dan sirah nabawiyah yang aplikatif dalam kehidupan",
    icon: Brain,
  ...
  },
  {
    id: 4,
    title: "Keasramaan",
    description: "Membina santri dengan disiplin, adab dan kepemimpinan melalui kehidupan bersama ala Agile Learning yang kolaboratif dan adaptif",
    icon: BookOpen,
  ...
  },
  {
    id: 5,
    title: "IT",
    description: "Membekali santri dengan keterampilan digital, coding, literasi teknologi, untuk menghadapi tantangan era modern",
    icon: Earth,
  ...
  },
  {
    id: 6,
    title: "Umum",
    description: "Program dengan Ruangguru adalah kolaborasi pembelajaran bersama untuk menguatkan dan mengintegrasikan kurikulum Diknas sehingga selaras dengan kebutuhan santri.",
    icon: Code,
